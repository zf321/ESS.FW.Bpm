...
{
    public class UriElementReferenceImpl<TTarget, TSource> : ElementReferenceImpl<TTarget, TSource> 
        where TTarget : IModelElementInstance where TSource : IModelElementInstance
    {

        public UriElementReferenceImpl(IChildElement referenceSourceCollection) : base(referenceSourceCollection)
        {
        }
