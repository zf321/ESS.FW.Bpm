...
//        /// <returns> the value of the first result entry or null if none exists
//        /// </returns>
...
//        /// @param <T>
//        ///          the type of the result entry </param>
//        /// <returns> the typed value of the first result entry or null if none exists
//        /// </returns>
//        /// <seealso cref= #getFirstEntry() </seealso>
//        T GetFirstEntryTyped<T>() where T : ITypedValue;
...
//        /// @param <T>
//        ///          the type of the result entry </param>
//        /// <returns> the value for the given name or null if no value exists for this
//        ///         name
//        /// </returns>
...
//        T GetEntryTyped<T>(string name) where T : ITypedValue;

//        /// <summary>
//        /// Returns a map of the result entry values by output name.
//        /// </summary>
//        /// <returns> the values of the decision result entries
//        /// </returns>
...
//        /// </summary>
//        /// <returns> the typed values of the decision result entries
//        /// </returns>
