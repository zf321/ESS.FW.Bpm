...
{
    public class SendTaskImpl : TaskImpl, ISendTask
    {
        ...
        private class ModelTypeInstanceProviderAnonymousInnerClass : IModelTypeInstanceProvider<ISendTask>
        {
            public virtual ISendTask NewInstance(ModelTypeInstanceContext instanceContext)
            {
        ...
        public new SendTaskBuilder Builder()
        {
            return new SendTaskBuilder((IBpmnModelInstance)modelInstance, this);
        }
