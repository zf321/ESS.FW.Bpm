...
{
    public class CamundaExecutionListenerImpl : BpmnModelElementInstanceImpl, ICamundaExecutionListener
    {
        ...
        {
            IModelElementTypeBuilder typeBuilder = modelBuilder.DefineType<ICamundaExecutionListener>(/*typeof(ICamundaExecutionListener),*/ BpmnModelConstants.CamundaElementExecutionListener)
        ...
        private class ModelTypeInstanceProviderAnonymousInnerClass : IModelTypeInstanceProvider<ICamundaExecutionListener>
        {
            public virtual ICamundaExecutionListener NewInstance(ModelTypeInstanceContext instanceContext)
            {
