...
namespace ESS.FW.Bpm.Model.Dmn.impl.instance
{
    ...
    public class TextImpl : DmnModelElementInstanceImpl, IText
    {
        ...
        {
            IModelElementTypeBuilder typeBuilder = modelBuilder.DefineType<IText>(/*typeof(IText), */DmnModelConstants.DmnElementText).NamespaceUri(DmnModelConstants.Dmn11Ns).InstanceProvider(new ModelTypeInstanceProviderAnonymousInnerClass());
