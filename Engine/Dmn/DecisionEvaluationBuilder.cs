...
namespace ESS.FW.Bpm.Engine.Dmn
{
    ...
    ///     
    /// </summary>
    public interface IDecisionEvaluationBuilder
    {
        /// <summary>
        ...
        /// </summary>
        IDecisionEvaluationBuilder SetDecisionDefinitionTenantId(string tenantId);

        /// <summary>
        ///     Specify that the decision definition belongs to no tenant. Can only be
        ///     used when the definition is referenced by <code>key</code> and not by <code>id</code>.
        /// </summary>
        IDecisionEvaluationBuilder DecisionDefinitionWithoutTenantId();

        /// <summary>
        ///     Set the version of the decision definition. If <code>null</code> then
        ///     the latest version is taken.
        /// </summary>
        IDecisionEvaluationBuilder SetVersion(int? version);

        /// <summary>
        ///     Set the input values of the decision.
        /// </summary>
        IDecisionEvaluationBuilder SetVariables(IDictionary<string, object> variables);
        ...
        /// </exception>
        IDmnDecisionTableResult Evaluate();
    }
}